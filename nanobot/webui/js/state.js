...
export const dom = {
  ...
  modelsToolsOnly: $("models-tools-only"),
  modelsFreeOnly: $("models-free-only"),
  modelsBody: $("models-body"),
  modelsCustomInput: $("models-custom-input"),
  modelsCustomApply: $("models-custom-apply"),
  jumpWrap: $("jump"),
  jumpBtn: $("jump-btn"),
  fileInput: $("file"),
  attachBtn: $("attach"),
